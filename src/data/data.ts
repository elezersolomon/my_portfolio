...
const profile : IProfile = {
  ...
  skills: {
    ...
    tools: ['Git', 'Postman', 'Chrome DevTools', 'AWS (S3, CloudFront, CodeCommit, lambda, APIGateway, code pipeline, AWS CDK(typescript)', 'jest', 'Github, GitLab, Docker unit testing with Jest,Flutter, '],
  ...
  experiences: [
    ...
    },
    {
      ...
      startDate: 'Nov 2020',
      summary: 'Start-up E-commerce platform development with NextJS.● Backend application development with NodeJS, GraphQL, MySQL.',
  ...
  certifications: [{
    ...
    issuedBy: 'CISCO',
    verificationURL: 'https://www.credly.com/badges/5cdb9005-b7c2-4d42-8ea2-c4f496d4672a/linked_in',
  },
  {
    name: 'Micro-frontends with React: a complete developers guide – Udemy.',
    issuedBy: 'Udemy',
    verificationURL: 'https://www.udemy.com/certificate/UC-611db799-52d5-4d52-9597-e6b85c0d7cbe/',
  },
  ],
  projects: [
    {
      ...
      url: '',
      description: [
        'An e-commerce platform to enable users to use telegram bot to post, edit and delete a product for sale', 'Still in production'],
    ...
    },
    {
      ...
      companyName: 'HURRICANE SUPPORT',
      url: '',
      description: ['A desktop and mobile application that enables assignment, delegation, completion, approval, and overall management of a task depending on the hierarchy and position of employees in the company.', 'Still in production'],
      tags: ['ReactJS', 'CSS', 'React Native', 'Axios', 'MaterialUI', 'nodejs', 'pouchDB', 'CouchDB'],
    },
    {
      name: 'MuluG',
      ...
      companyName: 'HURRICANE SUPPORT',
      url: '',
      description: ['A web application that enables a hospital to Register patients, Present information for patients, Receive a request from a patient, Follow up on patient, Receive payment from patients, and Que patents.', 'Still in production'],
    ...
    },
    {
      ...
      description: ['A web application that provides information about SpaceX launches'],
      tags: ['ReactJS', 'bootstrap', 'NodeJS', 'GraphQL', 'Apolo', 'Express', 'spcex rockets API'],
    },
  ],
  goodByeText: '',
};
